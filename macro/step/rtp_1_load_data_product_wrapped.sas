...
*    %rtp_1_load_data_product_wrapped(mpMode=S, mpOutScore=casuser.all_ml_scoring);
*	 %rtp_1_load_data_product_wrapped(mpMode=T, mpOutTrain=casuser.all_ml_train);
*	 %rtp_1_load_data_product_wrapped(mpMode=A, mpOutTrain=casuser.all_ml_train, mpOutScore=casuser.all_ml_scoring);
*
****************************************************************************
...
****************************************************************************/
%macro rtp_1_load_data_product_wrapped(mpMode=A,
	...
	%tech_job_details(mpMODE=START, mpSTEP_TYPE=proc)
	proc fedsql sessref=casauto; 
		...
		;
	quit;
	%tech_job_details(mpMODE=END, mpSTEP_TYPE=proc)
	...
	%tech_job_details(mpMODE=START, mpSTEP_TYPE=data)
	...
	run;
	%tech_job_details(mpMODE=END, mpSTEP_TYPE=data)
...
%mend rtp_1_load_data_product_wrapped;