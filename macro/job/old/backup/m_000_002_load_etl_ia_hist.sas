...
******************************************************************/
%macro m_000_002_load_etl_ia_hist;
	...
	%macro m_load_etl_ia_hist;
		...
		systask command 
		"""/opt/sas/mcd_config/bin/start_sas.sh"" ""%sysfunc(pathname(par_&seq))"" m_000_002_load_etl_ia_hist &tpResource"
...
%mend m_000_002_load_etl_ia_hist;