...
******************************************************************/
%macro m_001_load_etl_stg;

	%let etls_jobName=m_001_load_etl_stg;
	%etl_job_start;
	...
	%macro m_load_etl_stg_reg;
		...
		systask command 
		"""/opt/sas/mcd_config/bin/start_sas.sh"" ""%sysfunc(pathname(par_&seq))"" m001_load_etl_stg_reg &tpResource"
