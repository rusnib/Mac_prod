...
******************************************************************/
%macro m000_001_load_etl_stg_hist;

	%let etls_jobName=m000_001_load_etl_stg_hist;
	%etl_job_start;
	...
	%macro m_load_etl_stg_hist;
		...
		systask command 
		"""/opt/sas/mcd_config/bin/start_sas.sh"" ""%sysfunc(pathname(par_&seq))"" 000_load_data_history load_etl_stg_&tpResource"
...
%mend m000_001_load_etl_stg_hist;